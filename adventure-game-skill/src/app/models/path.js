module.exports = class Path {
    constructor(data) {
        ...
        this.go = data.go; // Function, execute the effects of going to the goesTo location, returns empty if the player should go to goesTo or the name of the next scene
